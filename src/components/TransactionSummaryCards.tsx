      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/30 dark:to-gray-800/30 rounded-xl shadow p-8 mb-6 border border-gray-200 dark:border-gray-700">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Adicione transações para ver os resumos financeiros
          </p>
        </div>
      </div>
    );
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/30 rounded-xl shadow p-5 border border-emerald-100 dark:border-emerald-800/50">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-emerald-700 dark:text-emerald-300">Total de Receitas</p>
            <p className="text-2xl font-bold mt-1 text-emerald-800 dark:text-emerald-100">{formatCurrency(totalIncomePaid)}</p>
          </div>
        ...
        <div className="mt-3">
          ...
          <div className="mt-2 pt-2 border-t border-emerald-200 dark:border-emerald-700/50">
            <div className="flex items-center justify-between text-sm font-semibold">
              <span className="text-emerald-800 dark:text-emerald-200">Total Previsto</span>
              <span className="text-emerald-800 dark:text-emerald-200">{formatCurrency(totalIncomeProjected)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/30 rounded-xl shadow p-5 border border-red-100 dark:border-red-800/50">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-red-700 dark:text-red-300">Total de Despesas</p>
            <p className="text-2xl font-bold mt-1 text-red-800 dark:text-red-100">{formatCurrency(totalExpensesPaid)}</p>
          </div>
        ...
        <div className="mt-3">
          ...
          <div className="mt-2 pt-2 border-t border-red-200 dark:border-red-700/50">
            <div className="flex items-center justify-between text-sm font-semibold">
              <span className="text-red-800 dark:text-red-200">Total Previsto</span>
              <span className="text-red-800 dark:text-red-200">{formatCurrency(totalExpensesProjected)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`bg-gradient-to-br ${balancePaid >= 0 ? 'from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30' : 'from-orange-50 to-orange-100 dark:from-orange-900/30 dark:to-orange-800/30'} rounded-xl shadow p-5 border ${balancePaid >= 0 ? 'border-blue-100 dark:border-blue-800/50' : 'border-orange-100 dark:border-orange-800/50'}`}>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Balanço</p>
            <p className={`text-2xl font-bold mt-1 ${balancePaid >= 0 ? 'text-blue-800 dark:text-blue-100' : 'text-orange-800 dark:text-orange-100'}`}>
              {formatCurrency(balancePaid)}
            </p>
          </div>
          <div className={`p-3 ${balancePaid >= 0 ? 'bg-blue-100 dark:bg-blue-800/50' : 'bg-orange-100 dark:bg-orange-800/50'} rounded-lg`}>
            <Wallet className={`h-6 w-6 ${balancePaid >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'}`} />
          </div>
        </div>
        <div className="mt-3">
          <div className="flex items-center justify-between text-sm">
            <div className={`flex items-center ${balancePaid >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'}`}>
              {balancePaid >= 0 ? (
            ...
            <span className={`font-medium ${balancePaid >= 0 ? 'text-blue-700 dark:text-blue-300' : 'text-orange-700 dark:text-orange-300'}`}>
              {formatCurrency(balancePaid)}
            </span>
          </div>
          <div className="flex items-center justify-between text-sm mt-1">
            ...
            <span className={`font-medium ${balanceProjected >= 0 ? 'text-emerald-700 dark:text-emerald-300' : 'text-red-700 dark:text-red-300'}`}>
